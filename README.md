...
```
{bvid}-{name}/{last_ts}/
├── 01_播放与互动.png       播放量 + 点赞/投币双轴趋势
├── 02_互动增量.png         各互动指标的堆叠面积变化
├── 03_互动转化效率.png     每次播放产生的互动价值评分
├── 04_三连率.png           点赞/投币/收藏 ÷ 播放
├── 05_观看留存率.png       实际播放 vs 在线人数期望
├── 06_平均观看时长.png     单次访问占视频全长的百分比
├── 07_传播效率.png         播放增速与在线密度的关系 (≥15条)
└── 08_分享传播影响.png     转发对播放增量的前置关联 (≥20条)
```
